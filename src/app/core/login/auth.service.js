(function() {
    ...
    function auth($http, $location, $rootScope, $state, $timeout, $window, accountsAPI, alert, AuthUser, jwtHelper) {
        ...
        function login() {
            ...
            window.location.href = "https://accounts.organicity.eu/realms/organicity/protocol/openid-connect/auth/?response_type=token&client_id=experimenter-portal&redirect_uri=https://experimenters.organicity.eu/&scope=&state=";
        }
