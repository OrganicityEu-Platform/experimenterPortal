(function() {
    ...
    angular.module('app.components')
        .factory('ExperimentDetail', ['ExperimentsAPI', 'ApplicationsAPI', 'DevicesAPI', 'AssetsAPI', 'TagsAPI',
            ExperimentDetail
        ]);

    function ExperimentDetail(ExperimentsAPI, ApplicationsAPI, DevicesAPI, AssetsAPI, TagsAPI) {
